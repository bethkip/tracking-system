...
<html>
    ...
    <body>
        ...
        <ul style="float:left;width: 100%;height: 100px;margin-top: 30px">
            <li align="middle"><i class="fa fa-list-ul" align="" style="color:white; font-size: 30px"></i>&nbsp;&nbsp;About page</li>
        ...
        <div class='content'>
            <center><h2>About the developer</h2></center>
            <p>SIN: 16102354</p>
            <p>Full names: Aubrey Matende</p>
